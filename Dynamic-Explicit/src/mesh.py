...
res_axial = 50   # number of divisions along length was 4
res_circ  = 16   # around circumference

mesh_scale = 1.00 # global refinement factor (smaller -> finer) 0.15 ( 0.2 0.4 with res axial 4 )
